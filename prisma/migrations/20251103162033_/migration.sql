...
CREATE TABLE `Notification` (
    ...
    `type` ENUM('KYC_VERIFIED', 'ACCOUNT_VERIFIED', 'MESSAGE', 'SESSION_SCHEDULING', 'REFERRAL', 'ACTIVITY_PROGRESS', 'SECURITY') NOT NULL,
    `title` VARCHAR(191) NOT NULL,
    `message` TEXT NULL,
...
CREATE TABLE `ContentCourse` (
    ...
    `title` VARCHAR(191) NOT NULL,
    `description` TEXT NULL,
    `type` ENUM('MODULES', 'IMAGES', 'VIDEOS') NOT NULL,
