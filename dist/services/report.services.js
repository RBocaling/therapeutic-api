...
exports.getReportOverviewV2 = exports.getReportOverview = void 0;
...
const getReportOverviewV2 = async (counselorId) => {
    try {
        // 1️⃣ Fetch chat sessions for the counselor
        const data = await prisma_1.default.referral.findMany({
            where: { counselorId },
            include: {
                user: {
                    include: {
...
exports.getReportOverviewV2 = getReportOverviewV2;
