...
router.get("/v3", auth_middleware_1.authenticateUser, campaignController.listCampaignsV3);
...
router.get("/users-pendingv2", auth_middleware_1.authenticateUser, campaignController.UserspendingListCampaigns);
