...
exports.buildGuidedTlcPrompt = void 0;
const buildGuidedTlcPrompt = (opts) => {
    let duration = 14;
    if (opts.mhi38.resultCategory === "Responding")
        duration = 7;
    if (opts.mhi38.resultCategory === "Healthy")
        duration = 3;
    const demographic = [
...
exports.buildGuidedTlcPrompt = buildGuidedTlcPrompt;
