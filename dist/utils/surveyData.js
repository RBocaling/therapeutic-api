...
exports.seedAllSurveysData = void 0;
exports.seedAllSurveysData = [
    {
        ...
        questions: [
            ...
            {
                questionName: "How happy, satisfied, or pleased have you been with your personal life during the past month?",
            ...
            // ----------------- Q2: Scale_B_Time -----------------
            {
                questionName: "How much of the time have you felt lonely during the past month?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            {
                questionName: "How often did you become nervous or jumpy when faced with excitement or unexpected situations during the past month?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "How much of the time have you felt that the future looks hopeful and promising?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            {
                questionName: "How much of the time, during the past month, has your daily life been full of things that were interesting to you?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How much of the time, during the past month, did you feel relaxed and free from tension?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How much of the time have you generally enjoyed the things you do?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "During the past month, have you had any reason to wonder if you were losing your mind, or losing control over the way you act, talk, think, feel, or of your memory?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            {
                questionName: "How much of the time during the past month have you felt loved and wanted?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How much of the time, during the past month, have you been a very nervous person?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            {
                questionName: "When you have got up in the morning, the past month, about how often did you expect to have an interesting day?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 6 },
            ...
            {
                questionName: 'How much of the time have you felt tense or "high-strung"?',
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 1 },
            ...
            // ----------------- Q14: Scale_F_Control -----------------
            {
                questionName: "During the past month, have you been in firm control of your behaviour, thoughts, emotions or feelings?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            {
                questionName: "During the past month, how often did your hands shake when you tried to do something?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "During the past month, how often did you feel that you had nothing to look forward to?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "How much of the time during the past month, have you felt calm and peaceful?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How much of the time, during the past month, have you felt emotionally stable?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How much of the time during the past month have you felt downhearted and blue?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 1 },
            ...
            {
                questionName: "How often have you felt like crying, during the past month?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "During the past month, how often have you felt that others would be better off if you were dead?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "How much of the time, during the past month, were you able to relax without difficulty?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How much of the time, during the past month, did you feel that your love relationships, loving and being loved, were full and complete?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How often, during the past month, did you feel that nothing turned out for you the way you wanted it to?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            // ----------------- Q25: Scale_G_Nerves -----------------
            {
                questionName: 'How much have you been bothered by nervousness or your "nerves" during the past month?',
                questionType: "single_choice",
                options: {
                    options: [
                        {
            ...
            {
                questionName: "During the past month, how much of the time have you been a wonderful adventure for you?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            {
                questionName: "How often, during the past month, have you felt so down in the dumps that nothing could cheer you up?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "During the past month, did you think about taking your own life?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            {
                questionName: "During the past month, how much of the time have you felt restless, fidgety, or impatient?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 1 },
            ...
            {
                questionName: "During the past month, how much of the time have you been moody or brooded about things?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 1 },
            ...
            {
                questionName: "How often did you feel cheerful, lighthearted, or happy?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 6 },
            ...
            // ----------------- Q33: Scale_I_Anxious -----------------
            {
                questionName: "During the past month, have you been anxious or worried?",
                questionType: "single_choice",
                options: {
                    options: [
                        {
            ...
            {
                questionName: "How often during the past month did you find yourself trying to calm down?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Always", score: 1 },
            ...
            {
                questionName: "How much of the time have you been in low or very low spirits?",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "All of the time", score: 1 },
            ...
            // ----------------- Q37: Scale_J_Rested -----------------
            {
                questionName: "How often, during the past month, have you been waking up feeling fresh and rested?",
                questionType: "single_choice",
                options: {
                    options: [
            ...
            // ----------------- Q38: Scale_K_Stress -----------------
            {
                questionName: "During the past month, have you been under or felt you were under any strain, stress or pressure?",
                questionType: "single_choice",
                options: {
                    options: [
    ...
    // --- Other Surveys (PHQ-9, GAD-7, Combined) ---
    {
        ...
        questions: [
            ...
            {
                questionName: "Trouble concentrating on things, such as reading or watching television",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Not at all", score: 0 },
            ...
            {
                questionName: "Moving or speaking so slowly that other people could have noticed? Or being so fidgety or restless that you have been moving more than usual",
                questionType: "single_choice",
                options: {
                    options: [
                        { text: "Not at all", score: 0 },
    ...
    },
    {
        ...
        description: "A combined screening for depression and anxiety using PHQ-9 and GAD-7 scales.",
        code: "COMBINED",
        questions: [
            // --- PHQ-9 (Depression) ---
            {
